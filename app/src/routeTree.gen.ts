...
import { Route as Agi1Import } from './routes/agi.1'
...
const Agi1Route = Agi1Import.update({
  id: '/1',
  path: '/1',
  getParentRoute: () => AgiRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/agi/1': {
      ...
      path: '/1'
      fullPath: '/agi/1'
      preLoaderRoute: typeof Agi1Import
